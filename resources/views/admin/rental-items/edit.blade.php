        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.rental-items.update', $rentalItem->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                @if ($rentalItem->image)
                                    <img id="imagePreview" src="{{ asset('storage/' . $rentalItem->image) }}"
                                        alt="Gambar Item" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control @error('category') is-invalid @enderror" required>
                                ...
                                <option value="ball"
                                    {{ old('category', $rentalItem->category) == 'ball' ? 'selected' : '' }}>
                                    Bola
                                </option>
                                <option value="jersey"
                                    {{ old('category', $rentalItem->category) == 'jersey' ? 'selected' : '' }}>
                                    Jersey
                                </option>
                                <option value="shoes"
                                    {{ old('category', $rentalItem->category) == 'shoes' ? 'selected' : '' }}>
                                    Sepatu
                                </option>
                                <option value="other"
                                    {{ old('category', $rentalItem->category) == 'other' ? 'selected' : '' }}>
                                    Lainnya
                                </option>
                            </select>
                            @error('category')
                        ...
                        <div class="form-group">
                            ...
                            <select name="condition" class="form-control @error('condition') is-invalid @enderror">
                                ...
                                <option value="Baru"
                                    {{ old('condition', $rentalItem->condition) == 'Baru' ? 'selected' : '' }}>Baru
                                </option>
                                <option value="Sangat Baik"
                                    {{ old('condition', $rentalItem->condition) == 'Sangat Baik' ? 'selected' : '' }}>
                                    Sangat Baik</option>
                                <option value="Baik"
                                    {{ old('condition', $rentalItem->condition) == 'Baik' ? 'selected' : '' }}>Baik
                                </option>
                                <option value="Cukup Baik"
                                    {{ old('condition', $rentalItem->condition) == 'Cukup Baik' ? 'selected' : '' }}>Cukup
                                    Baik</option>
                            </select>
                            @error('condition')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $rentalItem->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
