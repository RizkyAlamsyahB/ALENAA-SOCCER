                        ...
                        <tbody>
                            @forelse($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $itemCount = count($transaction->fieldBookings) +
                                                         count($transaction->rentalBookings) +
                                                         count($transaction->photographerBookings);
                                            $productSale = \App\Models\ProductSale::where('order_id', 'PROD-' . $transaction->order_id)->first();
                                            if ($productSale) {
                                                $itemCount += $productSale->productSaleItems->count();
                                            }
                                        @endphp
                                        {{ $itemCount }} item
                                    </td>
