...
@section('breadcrumb', 'Tambah Paket Membership')
@section('header-title', 'Tambah Paket Membership')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Form Tambah Paket Membership</h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="sessions_per_week"
                                        ...
                                        value="{{ old('sessions_per_week', 3) }}" min="1" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="session_duration"
                                        ...
                                        value="{{ old('session_duration', 1) }}" min="1" required>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="card border">
                                    <div class="card-header bg-light">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="includes_photographer"
                                                ...
                                                {{ old('includes_photographer') ? 'checked' : '' }}
                                    ...
                                    <div class="card-body" id="photographer_options" style="{{ old('includes_photographer') ? '' : 'display: none;' }}">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="photographer_id"
                                                ...
                                                @foreach ($photographers as $photographer)
                                                    <option value="{{ $photographer->id }}"
                                                        {{ old('photographer_id') == $photographer->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="photographer_duration"
                                                ...
                                                value="{{ old('photographer_duration', 3) }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="card border">
                                    <div class="card-header bg-light">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="includes_rental_item"
                                                ...
                                                {{ old('includes_rental_item') ? 'checked' : '' }}
                                    ...
                                    <div class="card-body" id="rental_item_options" style="{{ old('includes_rental_item') ? '' : 'display: none;' }}">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="rental_item_id"
                                                ...
                                                @foreach ($rentalItems as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('rental_item_id') == $item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="rental_item_quantity"
                                                ...
                                                value="{{ old('rental_item_quantity', 2) }}" min="1">
