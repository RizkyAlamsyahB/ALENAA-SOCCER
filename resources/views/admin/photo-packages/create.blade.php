...
@section('title', 'Tambah Paket Foto Baru')
@section('breadcrumb', 'Tambah Paket Foto')
@section('header-title', 'Tambah Paket Foto Baru')
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Form Tambah Paket Foto</h4>

                <form action="{{ route('admin.photo-packages.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="number_of_photos" class="form-control @error('number_of_photos') is-invalid @enderror"
                                    value="{{ old('number_of_photos') }}" required>
