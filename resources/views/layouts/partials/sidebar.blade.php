    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item has-sub {{ request()->routeIs('admin.photographers.*') ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-camera"></i>
                        <span>Fotografer</span>
                    </a>
                    <ul class="submenu {{ request()->routeIs('admin.photographers.*') ? 'active' : '' }}">
                        <li class="submenu-item">
                            <a href="" class="submenu-link">Data Fotografer</a>
                        </li>
                        <li class="submenu-item">
                ...
                <li
                    class="sidebar-item has-sub {{ request()->routeIs('admin.transactions.*') ? 'active' : '' }}">
                    <a href="#" class="sidebar-link">
