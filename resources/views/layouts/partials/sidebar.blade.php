...
<style>
    .logo a {
        font-size: 16px;
        font-weight: bold;
        color: #435ebe; /* Warna sesuai dengan logo sebelumnya */
                    ...
                    <li class="sidebar-item has-sub {{ request()->routeIs('owner.reports.*') ? 'active' : '' }}">
                        ...
                        <ul class="submenu {{ request()->routeIs('owner.reports.*') ? 'active' : '' }}">
                            <li class="submenu-item {{ request()->routeIs('owner.reports.index') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.index') }}" class="submenu-link">Dashboard Laporan</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reports.revenue') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.revenue') }}" class="submenu-link">Ringkasan Pendapatan</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reports.field-revenue') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.field-revenue') }}" class="submenu-link">Pendapatan Lapangan</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reports.rental-revenue') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.rental-revenue') }}" class="submenu-link">Pendapatan Rental</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reports.photographer-revenue') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.photographer-revenue') }}" class="submenu-link">Pendapatan Fotografer</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reviews.summary') ? 'active' : '' }}">
                                <a href="{{ route('owner.reviews.summary') }}" class="submenu-link">Ringkasan Review</a>
                            </li>
                            <li class="submenu-item {{ request()->routeIs('owner.reports.transactions') ? 'active' : '' }}">
                                <a href="{{ route('owner.reports.transactions') }}" class="submenu-link">Riwayat Pendapatan POS</a>
                            </li>
                        </ul>
                    </li>
