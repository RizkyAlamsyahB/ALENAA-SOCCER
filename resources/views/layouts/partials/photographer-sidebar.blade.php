        ...
        <div class="sidebar-menu">
            <ul class="menu">
                <li class="sidebar-title">Main Menu</li>
                    ...
                    <li class="sidebar-title">photographers Panel</li>
                    ...
                    {{-- Upcoming Bookings --}}
                    <li class="sidebar-item {{ request()->routeIs('photographers.bookings') ? 'active' : '' }}">
                        {{-- <a href="{{ route('photographers.bookings') }}" class="sidebar-link"> --}}
                        <i class="bi bi-camera"></i>
                        <span>Pesanan Fotografi</span>
                        </a>
                    </li>

                    {{-- Field Assignments (if applicable) --}}
                    <li class="sidebar-item {{ request()->routeIs('photographers.field-assignments') ? 'active' : '' }}">
                        {{-- <a href="{{ route('photographers.field-assignments') }}" class="sidebar-link"> --}}
                    ...
                    <li class="sidebar-item {{ request()->routeIs('photographers.profile') ? 'active' : '' }}">
                        {{-- <a href="{{ route('photographers.profile') }}" class="sidebar-link"> --}}
                    ...
                    <li class="sidebar-item {{ request()->routeIs('photographers.portfolio') ? 'active' : '' }}">
                        {{-- <a href="{{ route('photographers.portfolio') }}" class="sidebar-link"> --}}
                        <i class="bi bi-images"></i>
                        <span>Portfolio Foto</span>
                        </a>
                    </li>
