    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>Anda memiliki jadwal foto baru dengan pelanggan kami. Berikut adalah detail sesi foto yang telah dijadwalkan:</p>

                <div class="booking-box">
                    <div class="booking-title">Informasi Sesi Foto</div>
                    <p>Mohon untuk hadir tepat waktu dan mempersiapkan peralatan yang diperlukan untuk sesi foto ini.</p>
                </div>
                ...
                <div class="booking-details">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ \Carbon\Carbon::parse($booking->start_time)->format('l, d F Y') }}</div>
                    </div>
                    <div class="detail-row">
                        <div class="detail-label">Waktu:</div>
                        <div class="detail-value">{{ \Carbon\Carbon::parse($booking->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($booking->end_time)->format('H:i') }} WIB</div>
                    </div>
                    <div class="detail-row">
                        ...
                        <div class="detail-value">
                            @php
                                ...
                                try {
                                    $assignedField = \App\Models\Field::where('photographer_id', $photographerUserId)->first();
                                } catch (\Exception $e) {
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">FOTO-{{ sprintf('%06d', $booking->id) }}</div>
                    </div>
                </div>
                ...
                <div class="help-text">
                    <p>Jika Anda memiliki pertanyaan atau perlu membatalkan jadwal, silakan hubungi manajer Alena Soccer segera melalui WhatsApp di <strong>+62 812-3456-7890</strong>.</p>
                </div>
            </div>
