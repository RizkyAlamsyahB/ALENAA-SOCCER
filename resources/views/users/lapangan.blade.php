    ...
    <div class="container mt-4">
        ...
        <div class="row g-4">
                ...
                <div class="card border-0 rounded-4 shadow-sm hover-shadow">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/044664ba4bdf6e751b907ef4f4555d90041b6947df1b73075a20a385d181c41e"
                                class="img-fluid w-100" alt="Maincourt Field">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="card-title mb-0 fw-bold">Maincourt - Field A</h5>
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            ...
                            <a href="/maincourt" class="btn btn-primary btn-sm rounded-pill">
                                Book Now
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 rounded-4 shadow-sm hover-shadow">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/044664ba4bdf6e751b907ef4f4555d90041b6947df1b73075a20a385d181c41e"
                                class="img-fluid w-100" alt="Goalzone Field">
                            <div class="gallery-overlay">
                                <button class="view-btn">
                                    <i class="fas fa-expand-alt"></i>
                                    View Details
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="card-title mb-0 fw-bold">Goalzone - Field B</h5>
                            <div class="rating-badge">
                                <i class="fas fa-star text-warning me-1"></i>
                                <span>4.5</span>
                            </div>
                        ...
                        <div class="mt-3 d-flex justify-content-between">
                            <div class="badge bg-warning bg-opacity-10 text-warning p-2">
                                <i class="fas fa-clock me-1"></i>Limited Slots
                            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 rounded-4 shadow-sm hover-shadow">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/044664ba4bdf6e751b907ef4f4555d90041b6947df1b73075a20a385d181c41e"
                                class="img-fluid w-100" alt="Striker Arena">
                            <div class="gallery-overlay">
                                <button class="view-btn">
                                    <i class="fas fa-expand-alt"></i>
                                    View Details
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="card-title mb-0 fw-bold">Striker Arena</h5>
                            <div class="rating-badge">
                                <i class="fas fa-star text-warning me-1"></i>
                                <span>4.7</span>
                            </div>
            ...
            <div class="col-12 mt-4">
                <nav aria-label="Venues pagination" class="d-flex justify-content-center">
                    <ul class="pagination">
