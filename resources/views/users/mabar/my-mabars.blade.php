                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="mabar-icon me-3 d-flex align-items-center justify-content-center bg-danger-subtle rounded-circle" style="width: 40px; height: 40px;">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="fw-medium">{{ $mabar->filled_slots }}/{{ $mabar->total_slots }}</span>
                                            <div class="progress ms-2" style="width: 60px; height: 6px;">
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: {{ $mabar->filledPercentage() }}%;" aria-valuenow="{{ $mabar->filledPercentage() }}" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('user.mabar.show', $mabar->id) }}" class="btn btn-sm btn-outline-primary">
