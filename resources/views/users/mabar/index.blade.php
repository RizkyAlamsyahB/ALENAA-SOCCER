                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="search-input">
                                    ...
                                    <input type="text" name="search" class="form-control ps-5" placeholder="Cari event mabar..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" name="location">
                                    ...
                                    @foreach($fields as $field)
                                        <option value="{{ $field->id }}" {{ request('location') == $field->id ? 'selected' : '' }}>
                                            {{ $field->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2">
                                <select class="form-select" name="sort">
                                    ...
                                    <option value="price_lowest" {{ request('sort') == 'price_lowest' ? 'selected' : '' }}>Harga Terendah</option>
                                    <option value="price_highest" {{ request('sort') == 'price_highest' ? 'selected' : '' }}>Harga Tertinggi</option>
                                </select>
                            </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="price-info">
                                    <span class="h5 mb-0 text-danger">Rp{{ number_format($mabar->price_per_slot, 0, ',', '.') }}</span>
                                    <small class="text-muted">/orang</small>
                                </div>
                                <a href="{{ route('user.mabar.show', $mabar->id) }}" class="btn btn-outline-danger rounded-pill">
                                    Detail
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm rounded-4 py-5">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">Saat ini belum ada open mabar yang tersedia sesuai filter Anda.</p>
                            <a href="{{ route('user.mabar.create') }}" class="btn btn-danger rounded-pill px-4 py-2">
                                <i class="fas fa-plus-circle me-2"></i> Buat Open Mabar
                            </a>
                        </div>
