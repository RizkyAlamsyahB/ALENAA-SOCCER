                                ...
                                <div class="col-md-6">
                                    <div class="detail-item d-flex mb-3">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="mb-0">{{ \Carbon\Carbon::parse($openMabar->start_time)->format('D, d M Y') }}</p>
                                            <p class="mb-0">{{ \Carbon\Carbon::parse($openMabar->start_time)->format('H:i') }} -
                                               {{ \Carbon\Carbon::parse($openMabar->end_time)->format('H:i') }} WIB</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="detail-item d-flex mb-3">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="mb-0 fw-bold">Rp{{ number_format($openMabar->price_per_slot, 0, ',', '.') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar me-2">
                                                    @if($participant->user->profile_picture)
                                                        <img src="{{ Storage::url($participant->user->profile_picture) }}" alt="{{ $participant->user->name }}" width="32" height="32" class="rounded-circle">
                                                    @else
                                        ...
                                        <td>
                                            @if($participant->status == 'joined' && $participant->payment_status == 'pending')
                                                <form action="{{ route('user.mabar.mark.attended', ['mabarId' => $openMabar->id, 'participantId' => $participant->id]) }}" method="POST">
                                                    @csrf
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="{{ Auth::id() == $openMabar->user_id ? '5' : '4' }}" class="text-center py-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4 sticky-md-top" style="top: 100px;">
                    <div class="card-body p-4">
                        ...
                        <div class="price-section d-flex justify-content-between align-items-center mb-3 p-3 bg-light rounded-3">
                            <div>
                                <span class="text-muted">Harga per orang</span>
                                <h4 class="mb-0 text-danger">Rp{{ number_format($openMabar->price_per_slot, 0, ',', '.') }}</h4>
                            </div>
                            <div>
                        ...
                        <div class="progress mb-4" style="height: 10px;">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: {{ $openMabar->filledPercentage() }}%;" aria-valuenow="{{ $openMabar->filledPercentage() }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
