...
@endif
                        ...
                        <form action="{{ route('user.mabar.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="field_booking_id" name="field_booking_id" class="form-select @error('field_booking_id') is-invalid @enderror" required>
                                    <option value="" disabled selected>-- Pilih Booking Lapangan --</option>
                                    @foreach($availableBookings as $booking)
                                        <option value="{{ $booking->id }}" {{ old('field_booking_id') == $booking->id ? 'selected' : '' }}>
                                            {{ $booking->field->name }} -
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="price_per_slot" name="price_per_slot" class="form-control @error('price_per_slot') is-invalid @enderror" value="{{ old('price_per_slot') }}" min="0" required>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="total_slots" name="total_slots" class="form-control @error('total_slots') is-invalid @enderror" value="{{ old('total_slots') }}" min="1" max="30" required>
                                @error('total_slots')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="alert alert-info mb-4">
                                ...
                                <ul class="mb-0 ps-3">
                                    <li>Open Mabar akan secara otomatis menggunakan jadwal dan lapangan dari booking yang Anda pilih.</li>
                                    <li>Status pembayaran peserta dapat Anda konfirmasi saat mereka hadir di lapangan.</li>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('user.mabar.index') }}" class="btn btn-outline-secondary rounded-pill py-3">
