                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-2 col-sm-3 mb-3 mb-md-0">
                                                    <div class="cart-item-image">
                                                        @if(isset($item->field_image))
                                                            <img src="{{ Storage::url($item->field_image) }}" alt="{{ $item->field_name ?? 'Lapangan' }}" class="img-fluid rounded-3">
                                                        @else
                                                ...
                                                <div class="col-md-7 col-sm-6 mb-3 mb-md-0">
                                                    <div class="cart-item-details">
                                                        <h5 class="cart-item-title fw-bold mb-1">{{ $item->field_name ?? 'Lapangan' }}</h5>
                                                        <div class="cart-item-category mb-2">
                                                            <span class="type-badge">{{ $item->field_type ?? 'Olahraga' }}</span>
                                                        </div>
