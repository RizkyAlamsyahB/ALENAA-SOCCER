            ...
            <div class="col-lg-10">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 order-lg-1">
                        @php
                            $hasMembership =
                                $payment->membershipSubscriptions && count($payment->membershipSubscriptions) > 0;
                        @endphp
                        ...
                        @if ($hasMembership)
                            ...
                            <div class="card border-0 rounded-4 shadow-sm hover-shadow mb-4">
                                <div
                                    ...
                                    <span class="booking-count">{{ count($payment->membershipSubscriptions) }}
                                        Package</span>
                                </div>
                                <div class="card-body p-0">
                                                    ...
                                                    <div class="membership-info">
                                                        ...
                                                        <div class="membership-details">
                                                            <h4 class="membership-title">
                                                                {{ $subscription->membership->name ?? 'Membership Package' }}
                                                            </h4>
                                                    ...
                                                    <div class="schedule-info">
                                                        ...
                                                        <div class="schedule-details">
                                                            <h6 class="schedule-title">
                                                                {{ $booking->field->name ?? 'Lapangan' }}</h6>
                                            ...
                                            @foreach ($payment->rentalBookings as $booking)
                                                <div class="schedule-item">
                                                    <div class="schedule-info">
                                                        ...
                                                        <div class="schedule-details">
                                                            <h6 class="schedule-title">
                                                                {{ $booking->rentalItem->name ?? 'Rental Item' }}</h6>
                                                            <div class="schedule-meta">
                            ...
                            @if ($payment->photographerBookings && count($payment->photographerBookings) > 0)
                                <div class="card border-0 rounded-4 shadow-sm hover-shadow mb-4">
                                    <div
                                        ...
                                        <span class="booking-count">{{ count($payment->photographerBookings) }}
                                            Jadwal</span>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="schedule-list">
                                            @foreach ($payment->photographerBookings as $booking)
                                                <div class="schedule-item">
                                                    <div class="schedule-info">
                                                        ...
                                                        <div class="schedule-details">
                                                            <h6 class="schedule-title">
                                                                {{ $booking->photographer->name ?? 'Fotografer' }}</h6>
                                                            <div class="schedule-meta">
                        ...
                        @else
                                        ...
                                        <div class="booking-list">
                                            @foreach ($payment->fieldBookings as $booking)
                                                <div class="booking-item">
                                                    <!-- Booking Header dengan Status dan Actions -->
                                                    <div class="booking-item-header">
                                                        <div class="booking-status">
                                                            ...
                                                            @if ($booking->is_rescheduled)
                                                                <span class="status-pill reschedule-badge ms-2">
                                                                    <i class="fas fa-sync-alt me-1"></i>
                                                                    Reschedule {{ $booking->reschedule_count }}x
                                                                </span>
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="booking-item-content">
                                                        <div class="booking-image">
                                                            ...
                                                            <div class="field-type">
                                                                {{ $booking->field->type ?? 'Lapangan' }}</div>
                                                        </div>

                                                        <div class="booking-details">
                                                            <h5 class="field-name">
                                                                {{ $booking->field->name ?? 'Lapangan' }}</h5>
                                                            <div class="booking-info">
                                                                ...
                                                                @if ($booking->is_rescheduled && $booking->original_start_time)
                                                                    <div class="info-item original-schedule">
                                                                        <i class="fas fa-history text-info"></i>
                                                                        <span class="text-info">
                                                                            <strong>Jadwal asli:</strong>
                                                                            {{ \Carbon\Carbon::parse($booking->original_start_time)->format('d M Y, H:i') }}
                                                                            -
                                                    ...
                                                    @if ($booking->reschedule_reason && $booking->is_rescheduled)
                                                        <div class="reschedule-info">
                                                            <div class="reschedule-reason">
                                                                <i class="fas fa-comment text-info me-2"></i>
                                                                <strong>Alasan reschedule:</strong>
                                                    ...
                                                    <!-- Reschedule Warning -->
                                                    @if ($booking->can_reschedule && $booking->reschedule_count >= 1)
                                                        <div class="reschedule-warning">
                                                            <i class="fas fa-exclamation-triangle text-warning me-2"></i>
                                                            <small class="text-warning">
                                                                Anda sudah melakukan reschedule
                                                                {{ $booking->reschedule_count }} kali.
                                                                Maksimal reschedule adalah 2 kali.
                                                            </small>
                                                        </div>
                                                    @endif
                                                </div>
                            ...
                            <style>
                                /* Additional CSS untuk reschedule features */
                                .reschedule-badge {
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    // Add loading state to reschedule links
