    ...
    <div class="hero-section" style="margin-top: 50px;">
        <div class="container">
            <div class="hero-content">
                <h1 class="hero-title">Membership Saya</h1>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <i class="fas fa-user-tag"></i> Membership Saya
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        @if ($subscriptions->isEmpty())
            <div class="card border-0 rounded-4 shadow-sm">
                <div class="card-body p-5 text-center">
                    ...
                    <p class="text-muted mb-4">Anda belum memiliki paket membership aktif. Dapatkan keuntungan dengan
                        membeli paket membership kami.</p>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <div class="membership-info-item">
                                        ...
                                        <span>Mulai:
                                            {{ \Carbon\Carbon::parse($subscription->start_date)->format('d M Y') }}</span>
                                    </div>
                                    <div class="membership-info-item">
                                ...
                                <div class="membership-actions">
                                    <a href="{{ route('user.membership.subscription.detail', $subscription->id) }}"
                                        class="btn-outline">
                                    ...
                                    @if ($subscription->status === 'active')
                                        ...
                                        @if ($pendingPayment)
                                            <a href="{{ route('user.membership.renewal.pay', $pendingPayment->id) }}"
                                                class="btn-primary">
                                                <i class="fas fa-sync me-2"></i>
                                                <span>Lanjutkan Pembayaran</span>
                                            </a>
                                        @elseif($subscription->renewal_status !== 'renewed')
                                            <a href="{{ route('user.membership.manual.renewal', $subscription->id) }}"
                                                class="btn-primary">
                                                <i class="fas fa-sync me-2"></i>
