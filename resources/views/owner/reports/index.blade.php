                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <a href="{{ route('owner.reports.transactions') }}" class="text-decoration-none">
                                    <div class="card report-card shadow-sm h-100 transition-hover border-shadow">
                                        <div class="card-body d-flex flex-column align-items-center py-4">
                                            <div class="report-icon mb-3 d-flex align-items-center justify-content-center">
                                                <i class="bi bi-receipt text-primary" style="font-size: 2rem;"></i>
                                            </div>
                                            <h5 class="fw-bold">Riwayat Transaksi POS</h5>
                                            <p class="text-muted text-center">Riwayat lengkap semua transaksi POS
                                                berdasarkan periode waktu.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-4 col-sm-6 mb-4">
                                <a href="{{ route('owner.reports.product-sales-revenue') }}"
                                    ...
                                    <div class="card report-card shadow-sm h-100 transition-hover border-shadow">
                                        <div class="card-body d-flex flex-column align-items-center py-4">
                                            ...
                                            <h5 class="fw-bold">Pendapatan Penjualan Produk</h5>
                                            <p class="text-muted text-center">Analisis pendapatan dari penjualan produk
                                                berdasarkan kategori dan periode.</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
