    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createModernRevenueChart(data) {
                ...
                const photographerDataset = createModernDataset(allDates, photographerData, 'Fotografer', colors
                    .photographer);
            ...
            function createFieldTypeChart(data) {
                ...
                if (!data || !Array.isArray(data) || data.length === 0) {
                    ...
                    errorCtx.fillText("Data tipe lapangan tidak tersedia", errorCtx.canvas.width / 2, errorCtx
                        .canvas.height / 2);
                    return;
                }
                ...
                try {
                            ...
                            scales: {
                                ...
                                y: {
                                    ...
                                    ticks: {
                                        ...
                                        callback: function(value) {
                                            if (value >= 1000000) {
                                                return 'Rp ' + (value / 1000000).toLocaleString(
                                                    'id-ID') + ' jt';
                                            } else if (value >= 1000) {
                            ...
                            plugins: {
                                ...
                                tooltip: {
                                    ...
                                    callbacks: {
                                        ...
                                        label: function(context) {
                                            return 'Pendapatan Bersih: Rp ' + new Intl.NumberFormat(
                    ...
                    errorCtx.fillStyle = "#EF4444";
                    errorCtx.textAlign = "center";
                    errorCtx.fillText("Terjadi kesalahan saat memuat grafik", errorCtx.canvas.width / 2, errorCtx
                        .canvas.height / 2);
                }
            }
