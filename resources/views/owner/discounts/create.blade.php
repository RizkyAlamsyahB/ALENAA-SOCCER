    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Buat diskon baru untuk pelanggan Anda.</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" required placeholder="Contoh: SUMMER2025">
                                @error('code')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Diskon Musim Panas 2025">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('value') is-invalid @enderror" id="value" name="value" value="{{ old('value') }}" required min="0" step="0.01">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('applicable_to') is-invalid @enderror" id="applicable_to" name="applicable_to" required>
                                    ...
                                    <option value="bundle" {{ old('applicable_to') == 'bundle' ? 'selected' : '' }}>Bundel (Paket)</option>
                                </select>
                                @error('applicable_to')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('user_usage_limit') is-invalid @enderror" id="user_usage_limit" name="user_usage_limit" value="{{ old('user_usage_limit', 1) }}" required min="1">
