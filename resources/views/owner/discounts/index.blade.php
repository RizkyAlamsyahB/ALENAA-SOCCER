    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Diskon</h3>
                <p class="text-subtitle text-muted">Kelola semua diskon untuk pelanggan Anda di sini.</p>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-tools">
                    <a href="{{ route('owner.discounts.create') }}" class="btn btn-primary btn-sm rounded-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#discountsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('owner.discounts.index') }}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
